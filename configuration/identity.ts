export const OWNER_NAME: string = `Robert Sullivan`;
export const OWNER_DESCRIPTION: string = `${OWNER_NAME} is a senior at the University of North Carolina at Chapel Hill studying computer science.`;
